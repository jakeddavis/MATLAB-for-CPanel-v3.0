...
% Jake Davis
% 09/15/2018 - from PANAIR

function [A, areaCorrect]  = supCoordTrans(verts,M,a,b,nDir)
...
areaCorrect = 1 / (beta * sqrt(abs(dot(n_r, B*n_r))));
...
% % dot(n_c,nc_wind)
% 
% A1 = [1, 0, 0; 0, Bt*nz_c/gam, -Bt*ny_c/gam; Bt*ny_c/gam, 0, Bt*nz_c/gam];
...
% A = [(1/sqrt(abs(dot(n_r,n_r))))*C_r*u_r, (r*s/beta) * C_r*v_r ,...
