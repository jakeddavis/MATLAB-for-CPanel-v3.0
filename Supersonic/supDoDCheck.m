...
% 1 = at least partially inside -> influence

function [depFlag, edgeData] = supDoDCheck(M,verts,P,cntr,c0,nDir)
...
if dot(P - cntr, c0) >= 0 || dist < cond(1)
    ...
    % cntr of panel is further from domain than panel rad.
        ...
        if count > 0
            ...
            % check later after coord. trans has been performed
            depFlag = 1;
%             depFlag = supConeTriInter(verts,cntr,P,M,c0,nDir);
        end
    end
end
