...
function [Q1,w0] = supEdgeInfSubInters(R1,R2,ym1c,ym2c,xmc,m,z,delSmall,mFlag)
...
%             w01 = (1/(2*sqrt(1-m^2))) * log((-ym1c+R1*sqrt(1-m^2)) / (-ym1c-R1*sqrt(1-m^2)));
%         else
%             Q11 = 0;
%             w01 = 0;
% %             Q11 = sign(z)*atan2(xmc*R1, -abs(z)*ym1c);
% % %             w01 = (1/(2*sqrt(1-m^2))) * log((-ym1c+R1*sqrt(1-m^2)) / (-ym1c-R1*sqrt(1-m^2)));
% %              w01 = (1/(2*sqrt(1-m^2))) * log(-ym1c / -ym1c);
%         end
%         if R2 > delSmall
%             Q12 = sign(z)*atan2(xmc*R2, -abs(z)*ym2c);
%             w02 = (1/(2*sqrt(1-m^2))) * log((-ym2c+R2*sqrt(1-m^2)) / (-ym2c-R2*sqrt(1-m^2)));
%         else
%             Q12 = 0;
%             w02 = 0;
% %             Q12 = sign(z)*atan2(xmc*R2, -abs(z)*ym2c);
...
%             w01 = (m/(2*(1-m^2))) * log((-ym1c+R1*sqrt(1-m^2)) / (-ym1c-R1*sqrt(1-m^2)));
        else
%             Q11 = 0;
%             w01 = 0;
            Q11 = sign(z)*atan2(xmc*R1, -abs(z)*ym1c);
...
%             w02 = (m/(2*(1-m^2))) * log((-ym2c+R2*sqrt(1-m^2)) / (-ym2c-R2*sqrt(1-m^2)));
        else
%             Q12 = 0;
%             w02 = 0;
            R2 = 0;
